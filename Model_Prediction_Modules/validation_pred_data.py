...
class DBOperations:
    ...
    def data_insert(self, gooddir):
        '''
            ...
            On Failure: Logging error and raise exception
        '''
        self.log_writer.log(self.file_object, "Start inserting new good prediction data into SQL database")
        ...
        try:
            ...
            self.log_writer.log(self.file_object, f"The following error occured when inserting good prediction data into SQL database: {e}")
            raise Exception(f"The following error occured when inserting good prediction data into SQL database: {e}")
        conn.close()
        self.log_writer.log(self.file_object, "Finish inserting new good prediction data into SQL database")
    ...
    def compile_data_from_DB(self,compiledir):
        '''
            ...
            On Failure: Logging error and raise exception
        '''
        self.log_writer.log(self.file_object, "Start writing compiled good prediction data into a new CSV file")
        ...
        try:
            ...
            self.log_writer.log(self.file_object, f"The following error occured when compiling good prediction data into a new CSV file: {e}")
            raise Exception(f"The following error occured when compiling good prediction data into a new CSV file: {e}")
        conn.close()
        self.log_writer.log(self.file_object, "Finish writing compiled good prediction data into a new CSV file")
...
class rawpreddatavalidation(DBOperations):
    ...
    def load_pred_schema(self, filename):
        ...
        try:
            ...
            self.log_writer.log(self.file_object, f"Prediction schema fail to load with the following error: {e}")
            raise Exception(f"Prediction schema fail to load with the following error: {e}")
        self.log_writer.log(self.file_object, "Finish loading prediction schema")
        return schema
    ...
    def remove_temp_good_pred_data(self):
        ...
        for file in os.listdir(self.gooddir[:-1]):
            try:
                ...
                self.log_writer.log(self.file_object, f"{file} file deleted from Good_Prediction_Data folder")
            except PermissionError:
        ...
        self.log_writer.log(self.file_object, "Finish deleting all good_prediction_data files")
